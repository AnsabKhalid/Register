    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
          ...
          <!-- Sidebar Menu -->
          <nav class="">
              <a href="/laravel/student/student" class="nav-link active">
                <p>
                  Tables
                </p>
              </a>
              <a href="student/add" class="nav-link active">
                <p>
                  Form
                </p>
              </a>
...
<!-- <script type="text/javascript">
    $(document).ready(functiom() {
      ...
      table.on('click', '.edit', function() {
        ...
        $('#std_name').val(data[2]);
        $('#std_course').val(data[3]);
        $('#std_fee').val(data[4]);

        $('#editForm').attr('action', '/laravel/student/student/update/'+data[0]);
